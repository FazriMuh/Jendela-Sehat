    ...
    <div class="container-fluid our-header border-bottom mb-3">
      <div class="container">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3">
          ...
          <div class="col-md-3 ">
            <h4 style="font-weight: 800"><i class="fas fa-table me-2" style="color:#5e81f4"></i>E-MONEV <span style="font-weight: 200">1.0</span></h4>
          </div>

          <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
            <li><a href="<?PHP echo base_url()?>main_dashboard" class="nav-link px-2 link-secondary">Dashboard</a></li>
            <li><a href="<?PHP echo base_url()?>login" class="nav-link px-2 link-primary">Data Management</a></li>
            <li><a href="<?PHP echo base_url()?>guideline" class="nav-link px-2 link-secondary">Pedoman Umum</a></li>
          </ul>

          <div class="col-md-3 text-end">
            <a href="https://www.bappenas.go.id/" class="text-decoration-none me-3">
                <img class="img-logo" src="<?PHP echo base_url()?>assets/img/logo-bappenas.png">
              </a>
              <a href="https://indonesia.unfpa.org/en" class="text-decoration-none">
                <img class="img-logo" src="<?PHP echo base_url()?>assets/img/logo-unfpa.png">
              </a>
          </div>
        </header>
      </div>
